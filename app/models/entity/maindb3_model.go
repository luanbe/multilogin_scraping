...
type Maindb3 struct {
	...
	AddressStreet          string                   `gorm:"-" json:"Address_Street"`
	...
	DeedDate               string                   `gorm:"type:date;column:Deed_Date" json:"Deed_Date"`
	AppraisalDate          string                   `gorm:"type:date;column:Appraisal_Date" json:"Appraisal_Date"`
	...
	ZillowData             ZillowData               `gorm:"foreignKey:Maindb3ID;constraint:OnUpdate:CASCADE;OnDelete:SET NULL;"`
