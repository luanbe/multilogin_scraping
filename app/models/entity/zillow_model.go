...
type ZillowData struct {
	base.BaseIDModel
	Maindb3ID                  uint64   `gorm:"column:maindb3_id; not null" json:"maindb3_id"`
	...
	TimestampForDataExtraction string   `gorm:"type:timestamp" json:"timestamp_for_data_extraction"`
	Maindb3                    *Maindb3 `gorm:"foreignKey:maindb3_id" json:"maindb_3"`
}
